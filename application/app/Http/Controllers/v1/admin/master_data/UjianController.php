...
class UjianController extends Controller
{
    ...
    public function store(UjianRequest $quisRequest)
    {
        ...
        $materi = $this->ujianRepositories->store($quisRequest->safe()->only(['title', 'question', 'point', 'option', 'kategori_materi_id']));
        return $materi;
    }
    ...
    public function update(UjianRequest $ujianRequest, string $id)
    {
        ...
        $materi = $this->ujianRepositories->update($ujianRequest->safe()->only(['title', 'question', 'point', 'option', 'kategori_materi_id']), $id);
        return $materi;
    }
