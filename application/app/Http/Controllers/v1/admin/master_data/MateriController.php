...
class MateriController extends Controller
{
    ...
    public function store(MateriRequest $materiRequest)
    {
        ...
        $materi = $this->materiRepositories->store($materiRequest->safe()->only(['embed', 'judul', 'phase', 'isi', 'file_uri', 'kategori_materi_id', 'permalink', 'urutan', 'created_at', 'updated_at']));
        return $materi;
    }
    ...
    {
        $materi = $materiRequest->validated();
        $materi = $this->materiRepositories->update($materiRequest->safe()->only(['embed', 'judul', 'phase', 'isi', 'file_uri', 'kategori_materi_id', 'permalink', 'urutan', 'created_at', 'updated_at']), $id);
        return $materi;
    }
