...
class MateriController extends Controller
{
    ...
    public function store(MateriRequest $materiRequest)
    {
        ...
        $materi = $this->materiRepositories->store($materiRequest->safe()->only(['embed', 'judul', 'phase', 'isi', 'kategori_materi_id', 'permalink', 'created_at', 'updated_at']));
        return $materi;
    }
    ...
    {
        $materi = $materiRequest->validated();
        $materi = $this->materiRepositories->update($materiRequest->safe()->only(['embed', 'judul', 'phase', 'isi', 'kategori_materi_id', 'permalink', 'created_at', 'updated_at']), $id);
        return $materi;
    }
